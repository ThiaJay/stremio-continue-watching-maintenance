...
fs.writeFileSync("cw-v166-acceptance.txt",context+"\n");
fs.writeFileSync("cw-v166-acceptance.json",JSON.stringify({
...
echo "::error::No verified v1.6.6 target cleanup within bounded acceptance window"
exit 1
